...
public class DrawerHomeExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public DrawerHomeExpandableListAdapter(Context context, ExpandableListView listView, List<DrawerMenuItem> menuItemList, HashMap<DrawerMenuItem, List<String>> drawerMenuItemListHashMap) {
        mContext = context;
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.activity_main_drawer_listview_header, null);
        }
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null){
            LayoutInflater inflater = (LayoutInflater) this.mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            convertView = inflater.inflate(R.layout.activity_main_drawer_listview_item, null);
        }
